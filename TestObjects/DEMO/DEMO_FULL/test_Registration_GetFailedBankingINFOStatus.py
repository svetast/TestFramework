...
class TestRegistrationInvalidCardNumber(RegistrationPage1):
    """  Failed Banking INFO status [Card number 4242424242424242]
        possible get if use ONLY!!!!!!! PayScape payment system.
        We can select PayScape on ADMIN if Pay Scape payment system is present in Portal Payment Settings on ADMIN.
        We can check  Failed Banking INFO status only for the PORTAL => if Pay Scape payment system enabled  in Portal Payment Settings on ADMIN [order 1]"""
